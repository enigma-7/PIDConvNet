...
mname = "conv-%d-%d-dense-%d-%d"%(conv_size1,conv_size2, dense_size1, dense_size2)
...
net1.fit(x=X, y=T, batch_size = 100, epochs=20, validation_data=(Xv,Tv), callbacks=[tensorboard, csvlogger])
